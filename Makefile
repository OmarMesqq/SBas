...
debug:
	gcc -g -no-pie -Wall -Wextra -Winline main.c sbas.c utils.c assembler.c linker.c -o $(OUTPUT) -lm

release:
	gcc -O3 -Wall -Wextra -Winline  main.c sbas.c utils.c assembler.c linker.c -o $(OUTPUT) -lm

test:
	gcc -g -Wall -Wextra -Winline run_tests.c sbas.c utils.c assembler.c linker.c -o $(TEST_OUTPUT)
